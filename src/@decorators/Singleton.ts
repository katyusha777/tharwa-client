...
export type TSingleton<T extends new (...args: any[]) => any> = T & {
  [SINGLETON_KEY]: T extends new (...args: any[]) => infer I ? I : never
}

export function Singleton<T extends new (...args: any[]) => any>(type: T) {
  return new Proxy(type, {
    // this will hijack the constructor
    construct(target: TSingleton<T>, argsList, newTarget) {
